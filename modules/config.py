...
# Prompts
SUMMARY_PROMPT = (f"You are a developer working on a software project called {SOLUTION_NAME}. You have been asked to review the following and write a summary "
...
ITEM_PROMPT = ("You are a developer writing a summary of the work completed for the given devops work item. Ignore timestamps and links. Return only the description text with no titles, "
